...
#define KC_CFIT   LGUI(LALT(KC_F))
#define KC_LFIT   LGUI(LALT(KC_LEFT))
#define KC_RFIT   LGUI(LALT(KC_RIGHT))
#define KC_CTLLTB LCTL(KC_TAB)
#define KC_CTLRTB LCTL(LSFT(KC_TAB))
#define KC_GUIALT LGUI(KC_LALT)
#define KC_GUIESC GUI_T(KC_ESC)
#define KC_ALTBSP ALT_T(KC_BSPC)
#define KC_RAIEI LT(_RAISE, KC_LANG2)
#define KC_LOWKA LT(_LOWER, KC_LANG1)
